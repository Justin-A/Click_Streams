setwd("~/Desktop/clickstream/PA_Challenge_Data/")
...
train_clickstreams<-fread("train_clickstreams.tab", encoding = "")
train_clickstreams <- read.table("train_clickstreams.tab", sep = '\t')
train_clickstreams[,CUS_ID:= as.numeric(CUS_ID)]
